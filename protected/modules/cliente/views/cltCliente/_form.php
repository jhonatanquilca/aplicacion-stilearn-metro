    ...
    <div class="span12">
        ...
        <div class="widget border-green" id="widget-button">
            ...
            <div class="widget-content form bg-white">
                ...
                <?php echo $form->textFieldRow($model, 'nombre', array('maxlength' => 32, 'placeholder' => 'Tu Nombre')) ?>
                <?php echo $form->textFieldRow($model, 'apellido', array('maxlength' => 32, 'placeholder' => 'Tu Apellido')) ?>
                <?php echo $form->textFieldRow($model, 'documento', array('maxlength' => 20, 'placeholder' => '1002003004')) ?>
                <?php echo $form->textFieldRow($model, 'telefono', array('maxlength' => 24, 'placeholder' => '(06) 2-222-222')) ?>
                <?php echo $form->textFieldRow($model, 'celular', array('maxlength' => 24, 'placeholder' => '0999999999')) ?>
                <?php echo $form->textFieldRow($model, 'email_1', array('maxlength' => 50, 'placeholder' => 'usuario@ejemplo.com')) ?>
                <?php echo $form->textFieldRow($model, 'email_2', array('maxlength' => 50)) ?>
