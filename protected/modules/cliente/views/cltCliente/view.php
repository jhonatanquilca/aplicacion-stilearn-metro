...
$this->header = '<i class="aweso-user aweso-2x"></i> ' . $model->nombre_completo . ' - <strong>Deuda Total ' . ($model->cltDeudas ? '$ ' . number_format($model->cltDeudas['0']['monto'], 2,".", " ") : '$ 0.00').' ctvs.</strong>';
$this->menu = array(
